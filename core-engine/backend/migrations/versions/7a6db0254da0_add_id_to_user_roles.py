...
def upgrade() -> None:
    ...
    op.add_column('ai_commands', sa.Column('dsl_version', sa.String(length=50), nullable=False))
    op.add_column('ai_commands', sa.Column('parameters', postgresql.JSONB(astext_type=sa.Text()), nullable=True))
    op.add_column('ai_commands', sa.Column('approved_by_user_id', sa.UUID(), nullable=True))
    op.add_column('ai_commands', sa.Column('second_approver_id', sa.UUID(), nullable=True))
    op.add_column('ai_commands', sa.Column('mattermost_message_id', sa.String(length=255), nullable=True))
    ...
    op.alter_column('ai_commands', 'status',
    ...
    op.create_index(op.f('ix_ai_commands_status'), 'ai_commands', ['status'], unique=False)
    op.create_index(op.f('ix_ai_commands_tenant_id'), 'ai_commands', ['tenant_id'], unique=False)
    op.drop_constraint('ai_commands_approved_by_fkey', 'ai_commands', type_='foreignkey')
    op.drop_constraint('ai_commands_second_approver_fkey', 'ai_commands', type_='foreignkey')
    op.drop_constraint('ai_commands_tenant_id_fkey', 'ai_commands', type_='foreignkey')
    op.drop_constraint('ai_commands_issued_by_user_id_fkey', 'ai_commands', type_='foreignkey')
    op.create_foreign_key(None, 'ai_commands', 'users', ['issued_by_user_id'], ['id'], ondelete='CASCADE')
    op.create_foreign_key(None, 'ai_commands', 'users', ['approved_by_user_id'], ['id'], ondelete='SET NULL')
    op.create_foreign_key(None, 'ai_commands', 'users', ['second_approver_id'], ['id'], ondelete='SET NULL')
    op.create_foreign_key(None, 'ai_commands', 'tenants', ['tenant_id'], ['id'], ondelete='CASCADE')
    ...
    op.add_column('audit_logs', sa.Column('result', postgresql.JSONB(astext_type=sa.Text()), nullable=True))
    ...
    op.add_column('plugins', sa.Column('credentials_schema', postgresql.JSONB(astext_type=sa.Text()), nullable=True))
    op.add_column('plugins', sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False))
    op.alter_column('plugins', 'code_name',
               existing_type=sa.VARCHAR(length=100),
               type_=sa.String(length=255),
               comment=None,
               existing_comment='Định danh duy nhất dạng kebab-case. Dùng làm prefix cho bảng DB của Plugin.',
               existing_nullable=False)
    op.alter_column('plugins', 'icon_url',
               existing_type=sa.TEXT(),
               type_=sa.String(length=1024),
               existing_nullable=True)
    op.alter_column('plugins', 'manifest_url',
               existing_type=sa.TEXT(),
               type_=sa.String(length=1024),
               existing_nullable=False)
    op.alter_column('plugins', 'author',
               ...
               nullable=False)
    op.drop_index('idx_plugins_marketplace', table_name='plugins', postgresql_where='(deleted_at IS NULL)')
    ...
    op.create_index(op.f('ix_plugins_deleted_at'), 'plugins', ['deleted_at'], unique=False)
    ...
    op.alter_column('tenants', 'slug',
               ...
               existing_nullable=False)
    op.alter_column('tenants', 'keycloak_realm',
               existing_type=sa.VARCHAR(length=100),
               type_=sa.String(length=255),
               existing_nullable=False)
...
def downgrade() -> None:
    ...
    op.create_foreign_key('users_tenant_id_fkey', 'users', 'tenants', ['tenant_id'], ['id'], ondelete='RESTRICT')
    ...
    op.create_unique_constraint('user_roles_user_role_key', 'user_roles', ['user_id', 'role_id'])
    ...
    op.add_column('tenant_plugins', sa.Column('last_updated_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), autoincrement=False, nullable=False))
    op.create_table_comment(
        'tenant_plugins',
    ...
    op.drop_constraint(None, 'tenant_plugins', type_='foreignkey')
    op.drop_constraint(None, 'tenant_plugins', type_='foreignkey')
    op.create_foreign_key('tenant_plugins_tenant_id_fkey', 'tenant_plugins', 'tenants', ['tenant_id'], ['id'], ondelete='RESTRICT')
    op.create_foreign_key('tenant_plugins_installed_by_user_id_fkey', 'tenant_plugins', 'users', ['installed_by_user_id'], ['id'])
    op.create_foreign_key('tenant_plugins_plugin_id_fkey', 'tenant_plugins', 'plugins', ['plugin_id'], ['id'], ondelete='RESTRICT')
    ...
    op.create_index('idx_tenant_plugins_status', 'tenant_plugins', ['status'], unique=False)
    op.alter_column('tenant_plugins', 'installed_version',
               existing_type=sa.VARCHAR(length=50),
               nullable=True)
    op.alter_column('tenant_plugins', 'status',
               existing_type=sa.String(length=50),
               type_=postgresql.ENUM('INSTALLING', 'ACTIVE', 'FAILED_DIRTY', 'DISABLED', 'UNINSTALLING', 'DELETED', name='plugin_status'),
               existing_nullable=False,
    ...
    op.create_index('idx_tenant_integrations_tenant_id', 'tenant_integrations', ['tenant_id'], unique=False)
    op.create_table_comment(
        'roles',
    ...
    op.create_unique_constraint('roles_tenant_id_name_key', 'roles', ['tenant_id', 'name'])
    ...
    op.create_index('idx_plugins_marketplace', 'plugins', [sa.text('is_official DESC'), sa.text('download_count DESC')], unique=False, postgresql_where='(deleted_at IS NULL)')
    op.alter_column('plugins', 'author',
               existing_type=sa.VARCHAR(length=255),
               nullable=True)
    op.alter_column('plugins', 'manifest_url',
    ...
    op.add_column('audit_logs', sa.Column('metadata', postgresql.JSONB(astext_type=sa.Text()), server_default=sa.text("'{}'::jsonb"), autoincrement=False, nullable=True))
    op.add_column('audit_logs', sa.Column('actor_id', sa.UUID(), autoincrement=False, nullable=True))
    op.add_column('audit_logs', sa.Column('command_id', sa.UUID(), autoincrement=False, nullable=True, comment='Nếu do AI Agent thực hiện, trỏ đến bản ghi AI_COMMAND tương ứng.'))
    op.create_table_comment(
        'audit_logs',
    ...
    op.drop_constraint(None, 'audit_logs', type_='foreignkey')
    op.create_foreign_key('audit_logs_tenant_id_fkey', 'audit_logs', 'tenants', ['tenant_id'], ['id'], ondelete='RESTRICT')
    ...
    op.add_column('ai_commands', sa.Column('approved_by', sa.UUID(), autoincrement=False, nullable=True))
    op.add_column('ai_commands', sa.Column('dsl_payload', postgresql.JSONB(astext_type=sa.Text()), autoincrement=False, nullable=False))
    op.add_column('ai_commands', sa.Column('mattermost_msg_id', sa.VARCHAR(length=255), autoincrement=False, nullable=True))
    op.add_column('ai_commands', sa.Column('second_approver', sa.UUID(), autoincrement=False, nullable=True))
    op.add_column('ai_commands', sa.Column('session_id', sa.UUID(), autoincrement=False, nullable=False))
    op.create_table_comment(
        'ai_commands',
    ...
    op.drop_constraint(None, 'ai_commands', type_='foreignkey')
    op.drop_constraint(None, 'ai_commands', type_='foreignkey')
    op.create_foreign_key('ai_commands_issued_by_user_id_fkey', 'ai_commands', 'users', ['issued_by_user_id'], ['id'])
    op.create_foreign_key('ai_commands_tenant_id_fkey', 'ai_commands', 'tenants', ['tenant_id'], ['id'], ondelete='RESTRICT')
    op.create_foreign_key('ai_commands_second_approver_fkey', 'ai_commands', 'users', ['second_approver'], ['id'])
    op.create_foreign_key('ai_commands_approved_by_fkey', 'ai_commands', 'users', ['approved_by'], ['id'])
    ...
    op.create_index('idx_ai_commands_tenant_id', 'ai_commands', ['tenant_id'], unique=False)
    op.create_index('idx_ai_commands_status', 'ai_commands', ['status'], unique=False)
    op.create_index('idx_ai_commands_deadline', 'ai_commands', ['approval_deadline'], unique=False, postgresql_where="(status = 'PENDING_APPROVAL'::ai_command_status)")
    op.alter_column('ai_commands', 'status',
               existing_type=sa.String(length=50),
               type_=postgresql.ENUM('PENDING_APPROVAL', 'APPROVED', 'REJECTED', 'EXECUTING', 'COMPLETED', 'FAILED', 'TIMEOUT', name='ai_command_status'),
               existing_nullable=False,
               existing_server_default=sa.text("'PENDING_APPROVAL'::ai_command_status"))
    op.alter_column('ai_commands', 'effect',
               existing_type=sa.String(length=50),
