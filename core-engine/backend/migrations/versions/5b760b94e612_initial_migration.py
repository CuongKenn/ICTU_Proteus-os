...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_roles_plugin_code_name'), 'roles', ['plugin_code_name'], unique=False)
    ...
    sa.Column('dry_run_result', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
