...
from app.adapters.external.n8n_adapter import N8nAdapter, N8nAdapterError, N8nWorkflowNotFoundError
...
async def test_retry_on_5xx(adapter, mock_client):
    ...
    success_response = httpx.Response(200, json={"id": "wf-123", "name": "Test Workflow"})
