// Primitives dùng chung cho finance-module (dark theme, không phụ thuộc lib ngoài).
import React from 'react';
import { EXPENSE_STATUS_LABEL, type ExpenseStatus } from '../types';
...
export function Badge(props: { status: ExpenseStatus }) {
  return (
    <span
      style={{
    ...
    >
      {EXPENSE_STATUS_LABEL[props.status]}
    </span>
  );
}
